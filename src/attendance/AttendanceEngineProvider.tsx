      ...
      failReaction(
        m.reason === 'stub'
          ...
          : m.reason === 'verify-failed'
            ...
            : // ②フォームが最後まで来なかった。「操作できませんでした」は**掴めたが動かせなかった**と
              // 読めるので、ここに畳むと状況を誤って伝える（実機 2026-08-13 でこの経路に落ちた）。
              // 原因は断定しない＝入口側は attendanceMessage が 'none' で塞いだので、ここへ来るのは
              // まだ見ていない状態。**知らないことを知っているように書かない。**
              m.reason === 'form-missing'
              ? '提出フォームが開きませんでした。「CLASSの画面で書く」から提出してください'
